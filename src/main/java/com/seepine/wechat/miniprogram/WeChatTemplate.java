...
import com.seepine.wechat.miniprogram.constant.ApiConstant;
import com.seepine.wechat.miniprogram.constant.ErrorConstant;
import com.seepine.wechat.miniprogram.constant.KeyConstant;
import com.seepine.wechat.miniprogram.entity.*;
import com.seepine.wechat.miniprogram.exception.WeChatException;
import com.seepine.wechat.miniprogram.util.Assert;
import com.seepine.wechat.miniprogram.util.WxUtil;
/**
 * @author Seepine
 */
public class WeChatTemplate {
  ...
  public WeChatTemplate(String appId, String appSecret) {
    this(WeChatProperties.builder().appId(appId).appSecret(appSecret).build());
  }
